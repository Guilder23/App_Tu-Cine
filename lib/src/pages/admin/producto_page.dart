...
import 'package:peliculas/src/pages/admin/add_producto.dart';
...
class _ProductosPageState extends State<ProductosPage> {
                        ...
                        return Padding(
                          ...
                          child: Card(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Text(
                                'Bs/ ${productos[index]['precio'].toString()}',
                              ),
  ...
  Future<dynamic> dialogoEditProduct(
      BuildContext context, bool isDarkMode, int index) {
    final TextEditingController nombreController =
        TextEditingController(text: productos[index]['nombre']);
    final TextEditingController precioController =
        TextEditingController(text: productos[index]['precio'].toString());
    ...
    return showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: const Text(
            "Editar Producto",
            style: TextStyle(color: AppColors.acentColor, fontFamily: "CB"),
            textAlign: TextAlign.center,
          ),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              TextField(
                ...
                style: const TextStyle(color: AppColors.text, fontFamily: "CM"),
                decoration: const InputDecoration(
                  labelText: "Nombre del producto",
                  labelStyle: TextStyle(color: AppColors.text),
                  enabledBorder: UnderlineInputBorder(
                    borderSide: BorderSide(color: AppColors.acentColor),
                  ),
