...
class _BoleteriaPageState extends State<BoleteriaPage> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: const TextStyle(
            fontSize: 16, // Reduced from 19 to save space
            fontFamily: "CB",
          ),
        ),
      ),
      body: Padding(
        padding: const EdgeInsets.symmetric(
            horizontal: 16), // Reduced from 20 to save space
        child: Column(
          ...
          children: [
            Row(
              children: [
                Text(
                  ...
                  style: const TextStyle(
                      fontSize: 24,
                      fontFamily: "CB"), // Reduced from 28 to save space
                ),
                const Spacer(),
                IconButton(
                  onPressed: () {
            ...
            const Text(
              ...
              style: TextStyle(
                  fontSize: 14,
                  fontFamily: "CM"), // Reduced from 16 to save space
            ),
            const SizedBox(height: 8), // Reduced from 10 to save space

            // Selector de día optimizado (altura reducida)
            SizedBox(
              height: 45, // Reduced from 60 to save space
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      margin: const EdgeInsets.only(
                          right: 8), // Reduced from 10 to save space
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(
                            6.0), // Reduced from 8.0 to save space
                        child: Column(
                          children: [
                            Text(
                              '${now.day + index}',
                              style: TextStyle(
                                fontFamily: "CB",
                                fontSize: 14, // Added explicit size
            ...
            SizedBox(
              height: 36, // Reduced from 40 to save space
              child: ListView.builder(
                shrinkWrap: true,
                scrollDirection: Axis.horizontal,
                itemCount: 11,
            ...
            const SizedBox(height: 20), // Reduced from 30 to save space

            // Título de sección de butacas y precio
            Row(
              children: [
                const Text(
                  ...
                  style: TextStyle(
                      fontSize: 16,
                      fontFamily: "CB"), // Reduced from 17 to save space
                ),
                const Spacer(),
                Text(
                  'Bs/ ${totalPrice.toStringAsFixed(2)}',
                  style: TextStyle(
                    fontSize: 18, // Reduced from 20 to save space
                    color:
            ...
            Container(
              ...
              margin: const EdgeInsets.symmetric(
                  vertical: 8), // Reduced from 10 to save space
              decoration: BoxDecoration(
            ...
            const Align(
              ...
              child: Text(
                ...
                style: TextStyle(
                    fontSize: 14,
                    fontFamily: "CS"), // Reduced from 17 to save space
                textAlign: TextAlign.center,
              ),
            ),
            const SizedBox(height: 5),

            // Área de butacas mejorada con scroll suave
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, i) {
                  ...
                  return Column(
                    children: [
                      // Indicador de fila agregado
                      Padding(
                        padding: const EdgeInsets.only(top: 8, bottom: 4),
                        child: Text(
                          'Fila ${String.fromCharCode(65 + i)}', // A, B, C, etc.
                          style: TextStyle(
                            fontSize: 12,
                            fontFamily: "CM",
                      ...
                      // Butacas con mejor espaciado
                      Padding(
                        padding: const EdgeInsets.only(bottom: 8),
                        child: Wrap(
                          alignment: WrapAlignment.center,
                          spacing: 8, // Mayor espaciado entre butacas
                              ...
                              return GestureDetector(
                                ...
                                child: Container(
                                  height: MediaQuery.of(context).size.width *
                                      0.1, // Incrementado de 0.08 a 0.1
                                  width: MediaQuery.of(context).size.width *
                                      0.1, // Incrementado de 0.08 a 0.1
                                  decoration: BoxDecoration(
                                    color: isReserved
            ...
            // Información de precio y leyenda de colores
            Align(
              alignment: Alignment.center,
              child: Text(
                "Precio por butaca: Bs/ $ticketPrice",
                style: TextStyle(
                  fontSize: 14, // Reduced from 15 to save space
                  fontFamily: "CB",
                  color:
                      isDarkMode ? AppColors.lightColor : AppColors.darkColor,
                ),
            ...
            // Leyenda de colores optimizada (en una sola fila)
            Wrap(
            ...
            const SizedBox(height: 12), // Reduced from 20 to save space
          ],
        ),
      ),
    );
  ...
  // Widget para construir elementos de la leyenda de colores
  Widget _buildLegend(Color color, String text) {
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: [
        Container(
          height: 16, // Reduced from 20 to save space
          width: 16, // Reduced from 20 to save space
          decoration: BoxDecoration(
            color: color,
        ...
        const SizedBox(width: 4), // Reduced from 5 to save space
        Text(
          text,
...
// Dibujador de la pantalla del cine
